...
- Обязательно использование логирования в коде, с уровнями debug, info, warn, critical, error. Библиотеку для логирования можно выбрать по своему усмотрению, обзор логгеров тут [статья на habr.com](https://habr.com/ru/post/313686/))
- CDR-запись в файл.
